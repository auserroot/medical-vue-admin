    ...
    <div class="costBox">
      ...
      <div class="CostRecord">
        ...
        <el-menu
          ...
          class="el-menu-demo ks"
          mode="horizontal"
          @select="handleSelect"
          active-text-color="#ffd04b"
        >
          <el-submenu index="2" class="submenu" v-text="selectks">
            <template slot="title" class="submenu_title"></template>
            <el-submenu index="2-1" class="submenu">
              <template slot="title">内科</template>
              <el-menu-item index="消化内科">消化内科</el-menu-item>
              <el-menu-item index="血夜内科">血夜内科</el-menu-item>
              <el-menu-item index="免疫内科">免疫内科</el-menu-item>
            </el-submenu>

            <el-submenu index="2-4" class="submenu">
              <template slot="title">外科</template>
              <el-menu-item index="心胸外科">心胸外科</el-menu-item>
...
export default {
  ...
  methods: {
    deleteRow(index, rows) {
      this.$router.push("/cost/costDetial/" + rows[index].id);
      this.$store.commit("COSTDETIAL", rows);
    },

    getCost: async function (input3) {
      let res = await this.$http.get("cost", {});
      // MedicalCardNumber
